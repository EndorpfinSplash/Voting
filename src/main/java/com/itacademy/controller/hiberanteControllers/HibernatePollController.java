...
import com.itacademy.controller.requests.PollCreateRequest;
import com.itacademy.controller.requests.VariantAnswerCreateRequest;
...
@RestController
@CrossOrigin
@RequestMapping(value = "/rest/hiber/polls")
public class HibernatePollController {
